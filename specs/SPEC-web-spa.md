...
| `web/src/router.tsx`                                                    | React Router v6 configuration; defines all 7 routes under AppShell layout (Dashboard, Listings, Sweeps, SweepDetail, Filter, Analytics, Settings).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
